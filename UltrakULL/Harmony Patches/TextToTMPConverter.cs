...
public static class TextToTMPConverter
{
    ...
    private static void ConvertTextToTMP(Text source)
    {
        ...
        // Intermission shadow parent: hide it (the child carries the visible text).
        ...
        // Don't touch UnityExplorer / UniverseLib debug UI.
    ...
    {
        return source != null && (source.name == "Fish Caught Label" || source.name == "Fish Size Text");
    }
