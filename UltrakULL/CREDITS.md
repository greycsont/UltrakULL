...
- [JSON.Net](https://github.com/JamesNK/Newtonsoft.Json) by [NewtonSoft](https://www.newtonsoft.com/json), licensed under the MIT License.
- [arabic-support-unity](https://github.com/Konash/arabic-support-unity) by [Konash](https://github.com/Konash), licensed under the MIT license.
- [EMGU CV](https://github.com/emgucv/emgucv) — .NET wrapper for OpenCV, used for image processing and computer vision tasks in the mod. Licensed under the [BSD 3‑Clause License](https://github.com/emgucv/emgucv/blob/master/LICENSE).
