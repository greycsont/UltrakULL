...
### 项目情况
目前只支持文本相关，配音相关还是1.3.0那有点残疾的那套，纹理替换更是没开始搞（
...
### 字体
VCROSD的后备字体: 破晓像素体 (我知道这个字体不配但我找不到更好的了，找到的最好的是方正的那些像素字体但他要花钱授权，而且搞不好如果只买了一部分的授权另一部分没搞定然后一不小心直接赔的倾家荡产。如果找到更好的字体可以联系我)
