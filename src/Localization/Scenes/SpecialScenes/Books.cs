...
public static class Books
{
    public static string GetBookText(string originalText)
    {
        ...
        {
            foreach (var kvp in AngryLevelText.Books())
            {
                if (kvp.match.Equals(originalText))
                    return kvp.text;
            }
        ...
        switch (currentSceneName)
        {
            ...
            case "Level 5-S":
                if (originalText.Contains("DAY 529"))
                {
                    ...
                    + "\n\n\n<size=47>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=45>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=43>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=41>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=39>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=37>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=35>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=33>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=31>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=29>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=27>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=25>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=23>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=21>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=19>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=17>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=15>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=13>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=11>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=9>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=7>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=5>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=3>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
                    + "</size>\n<size=1>" + LanguageManager.CurrentLanguage.fishing.fish_book10 
